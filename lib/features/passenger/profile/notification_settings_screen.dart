...
import 'package:micromasr/features/passenger/profile/presentation/widgets/common/profile_section.dart';
import 'package:micromasr/features/passenger/profile/presentation/widgets/notifications/notification_switch_row.dart';
          ...
          children: [
            ...
            ProfileSection(
              ...
              children: [
                ...
                NotificationSwitchRow(label: 'تقييم الرحلة', value: tripRating, onChanged: (v) => setState(() => tripRating = v)),
              ],
            ),
